...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#DAA520' : 'black',

  concreteGray: darkMode ? '#292C2F' : '#E6E6E6',
  inputBackground: darkMode ? '#1F1F1F' : '#E6E6E6',
  ...
  // backgrounds / greys
  bg1: darkMode ? '#212429' : '#FFFEFD',
  bg2: darkMode ? '#2C2F36' : '#EBE8E0',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#DAA520',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #DAA52030 0%, #fff 0%)`
})
