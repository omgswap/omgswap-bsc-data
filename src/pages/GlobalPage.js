...
function GlobalPage() {
  ...
  return (
    <PageWrapper>
      <ThemedBackground backgroundColor={transparentize(0.75, '#DAA520')} />
      <ContentWrapper>
        <div>
          <AutoColumn gap="24px" style={{ paddingBottom: below800 ? '0' : '24px' }}>
            <TYPE.largeHeader>{below800 ? 'OMGSwap BSC BEP20 Analytics' : 'Omega Protocol - OMGSwap Binance Smart Chain BEP20 Analytics'}</TYPE.largeHeader>
            <Search />
            <GlobalStats />
          </AutoColumn>
